                    ...
                    try:
                        ...
                        try:
                            ...
                            for player_list in players:
                                ...
                                li_player_name = player_list.find_element(By.CLASS_NAME, 'name')
                                ...
                                li_player_pos = player_list.find_element(By.CLASS_NAME, 'position')
                                player_pos = li_player_pos.find_element(By.TAG_NAME, 'span').text
                                li_player_ht_wt = player_list.find_element(By.CLASS_NAME, 'size')
