...
class Player(models.Model):
    ...
    committed = models.ForeignKey(Committed, on_delete=models.SET_NULL, null=True,
                                 help_text='foreign key with commitment')


class Offer(models.Model):

    schools = models.ManyToManyField(School, null=True, help_text='many schools with many offer')
