...
class School(models.Model):
    ...
    name = models.CharField(max_length=250, null=True, blank=True)  # school name field with max length 150
...
class Offer(models.Model):
    ...
    name = models.CharField(max_length=150, null=True, blank=True, unique=True)  # team name field with max length 100
...
class Player(models.Model):
    ...
    school_name = models.ForeignKey(School, on_delete=models.SET_NULL, null=True)  # school-name model
