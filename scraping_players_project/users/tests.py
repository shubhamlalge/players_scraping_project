...
class UserTestCases(APITestCase):
    ...
    def test_create_user_pass(self):
        ...
        response = self.client.post('users/post/', self.data1, format='json')
    ...
    def test_update_user_pass(self):
        ...
        self.client.login(username='testuser', password='testpassword')  # Provide authentication credentials
