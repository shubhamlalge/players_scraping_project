...
from players.models import Player, Position, Class, State, School, City, Committed, Offer, Schools
        ...
        with open(csv_file, 'r') as csvfile:
            ...
            for players in reader:
                ...
                try:
                    ...
                    print(error)
                try:
                    school = School.objects.get_or_create(name=players[5])
                except Exception as error:
                    print(error)
                try:
                    ...
                    player_obj = Player.objects.create(image_url=players[0], full_name=players[1],
                                                       ...
                                                       state=state, clas=class_, school=school)
                except Exception as error:
                    print(error)
                ...
                try:
                    ...
                    for team_name, team_url in offers_elements.items():
                        ...
                        schools, _ = Schools.objects.get_or_create(name=team_name)
                        schools.url = team_url
                        schools.save()
                        # Add the school to the offer
                        offer.schools.add(schools)
