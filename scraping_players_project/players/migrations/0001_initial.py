    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('committed', models.ForeignKey(help_text='foreign key with commitment', null=True, on_delete=django.db.models.deletion.SET_NULL, to='players.committed')),
