...
def get_player_info(player_url, file_name):
    ...
    'This are the global variables which we use in try except block'
    ...
    try:
        ...
        'Here same we want to scrap highschool , city ,state ,class then we find ul and span tags'
        ...
        try:
            'then scrap then using indexing'
        ...
        "if can't found browser I throw an exception "
    ...
    try:
        ...
        try:
            ...
            print("view profile link not found")
            recruited_list = []
...
def main():
    ...
    try:
        ...
        print("web driver exception occur")
